...
class RePEc:
    ...
    def string_id(self):
        """Returns a string format for the NBER ID. For NBER ID above 1000 it will return itself.
        """
    ...
    def citation(self, timeout=None):
        """Returns either numbers of citations or numbers of being cited if any. Returns nothing if empty.
        """
    ...
    def reference(self, timeout=None):
    ...
    def save(self):
        """Save the data using JSON format."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--start", type=int, default=0, help="Start NBER ID", metavar="")
    parser.add_argument("-e", "--end", type=int, default=5, help="End NBER ID", metavar="")
